...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-r from-blue-400 to-blue-800">
      <div className="text-2xl text-white min-w-fit flex flex-col content-start items-start justify-start text-center' p-5 mt-10 mb-10 bg-gradient-to-r from-green-600 to-green-800 border-slate-200 border-solid border-4 rounded-full">
